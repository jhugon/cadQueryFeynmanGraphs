...
q1In = numpy.array((44,380))
q2In = q1In+numpy.array((70,0))
v1 = q1In+numpy.array((0,-70))
v2 = q2In+numpy.array((0,-70))
v3 = v1+numpy.array((0,-70))
v4 = v2+numpy.array((0,-70))
f1Out = v3+numpy.array((-30,-60))
f2Out = v3+numpy.array((+30,-60))
f3Out = v4+numpy.array((-30,-60))
f4Out = v4+numpy.array((+30,-60))
