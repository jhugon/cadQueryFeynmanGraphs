...
def sinWave(path,p1,p2,capped1=True,capped2=True,amp=5,period=50,width=10):
  p1 = numpy.array(p1)
  p2 = numpy.array(p2)
  propVec = p2-p1
...
#path.push(['M',100,100])
#path.push(['l',000,100])
sinWave(path,(100,200),(500,200))  # This thing isn't drawing the correct length
spiralLine(path,(100,400),(500,700))
dwg.add(path)
dwg.save()
